Post-earnings announcement drift (PEAD) is the tendency for a stock's cumulative abnormal returns to drift in the direction of an earnings surprise for a certain period of time, usually several weeks, following the earnings announcement date (EAD). It is one of the best-documented and most resilient capital market anomalies, first identified by @ball2013empirical. The academic profession has subjected the drift anomaly to extensive testing [@booth1996post; @liu2003post; @truong2011post], yet a rational, economic explanation for the drift remains elusive [@kothari2001capital].
